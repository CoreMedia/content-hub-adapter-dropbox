...
$ git submodule add https://github.com/CoreMedia/content-hub-adapter-dropbox.git content-hub-adapter-dropbox
$ git submodule init
$ git checkout -b content-hub-adapter-dropbox
```
...
```bash
$ mvn extensions:sync
$ mvn extensions:sync -Denable=content-hub-adapter-dropbox
``` 
